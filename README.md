...
## Version History
 * Unreleased: Fix two fallback request paths that could raise an unbound-name error: malformed function-ID posts to the API now reach the backend response, and hash-list cross comparison no longer runs an unused sample search (#201).

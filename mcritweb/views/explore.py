...
def families():
    ...
    return render_template("families.html", families=families, family_names=family_names, pagination=pagination, query=query, user_column_setup=user_column_setup, row_decorations=row_decorations)
...
def samples():
    ...
    return render_template("samples.html", samples=samples, family_names=family_names, job_collection=job_collection, pagination=pagination, query=query, user_column_setup=user_column_setup, row_decorations=row_decorations)
